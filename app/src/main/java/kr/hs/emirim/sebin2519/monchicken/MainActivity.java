...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBotton.setOnClickListener(this);//main_activity는 클릭을 담당할 거에요!, 이벤트 핸들러 마스터(핸들러, 처리자)
    }
     ...
     */
    @Override
    public void onClick(View v) { //클릭했을때 자동으로 이 메서드를 실행
        //누른 순간에 입력한것을 받아옴
...
//            Toast.makeText(th/이벤트 핸들러 클래스is,"이름을 입력해 주세요!",Toast.LENGTH_LONG).show();
//        }else {
